...
THREEx.JsArucoMarker = function(){
	...
	this.markerToObject3D = function(marker, object3d){
		...
		if( pose === null )	{
			console.log("POSE NULL");
			return;
		}
		//////////////////////////////////////////////////////////////////////////////////
		//		Translate pose to THREE.Object3D
		//////////////////////////////////////////////////////////////////////////////////
		//console.log("error: "+pose.bestError+"   error2:"+pose.alternativeError);
		...
		var difScale = Math.abs(this.modelSize-object3d.scale.x);
		var difRX = Math.abs(object3d.rotation.x-rx);
		var difRY = Math.abs(object3d.rotation.y-ry);
		var difRZ = Math.abs(object3d.rotation.z-rz);
		var difTX = Math.abs(object3d.position.x-tx);
		var difTY = Math.abs(object3d.position.y-ty);
		var difTZ = Math.abs(object3d.position.z-tz);

//console.log(difScale+" "+difRX+" "+difRY+" "+difRZ+" "+difTX+" "+difTY+" "+difTZ+" ");
//if(pose.bestError==0 && difRX>0.001 && difRY>0.001 && difRZ>0.001 && difTX>0.001 && difTY>0.001 && difTZ>0.001 ){
